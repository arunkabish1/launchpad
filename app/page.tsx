...
import { getEnvPat, getDefaultAccountId, getOrgName } from "@/lib/config";
...
export default async function Home() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-6 py-10">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-white">Launch an app to Cloudflare</h1>
        <p className="mt-1 text-sm text-slate-400">
          Choose a language, then a template. Launchpad scaffolds the project, creates a GitHub
          repo with deploy secrets, pushes the code, and GitHub Actions deploys it to Cloudflare.
        </p>
      </div>
      <Suspense
